...
const client = new Directus("http://localhost:8055");
    ...
    <>
      <header className="inscription-header">
        <button className="inscription-header__back">
          ...
          >
            <path
              d="M6.5 1.85718L1.5 7.00004M1.5 7.00004L6.5 12.1429M1.5 7.00004H17.5"
              stroke="white"
              stroke-width="2"
        ...
        <h2 className="inscription-header__subtitle">Tu nous as manqué !</h2>
      </header>
      <form className="authentification" onSubmit={(e) => handleSubmit(e)}>
        <input
          type="email"
          value={email}
