    ...
    <main className="user__account">
      ...
      <section className="user__project">
        ...
        <section className="project__description">
          ...
          <p className="price__amount">Lorem ipsum dolor sit amet. At culpa nihil et dolorem deserunt est quibusdam velit non inventore corporis. Eos impedit perspiciatis hic consequatur nobis aut excepturi eligendi hic ipsam fuga et dignissimos molestias.</p>
        </section>
